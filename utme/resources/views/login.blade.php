...
@section('title', 'Login here | Login :: UTME')
    ...
    <div class="row justify-content-center align-items-center no-gutters banner-agile">
        ...
        <div class="col-lg-4">
            <div class="wthree-form">
                <h4>Login to take test</h4>
                <p class="login-sub">If you don't have an account, 
                    <a href="/" style="color: #75BC2F;">click here to sign up</a>
                </p>
                <form class="register-wthree login-form">
